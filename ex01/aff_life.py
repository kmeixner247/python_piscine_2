...
"""
    try:
        ...
        assert type(df) is pd.core.frame.DataFrame, "second parameter must be a string"
...
loads the given path into a pandas dataframe, creates a plot for the given country
and displays that plot"""
